...
CORS(places, origins=['http://localhost:3000','https://burgers-and-beers.netlify.app'], supports_credentials=True)

CORS(user, origins=['http://localhost:3000','https://burgers-and-beers.netlify.app'], supports_credentials=True)
